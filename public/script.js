...
function formatMultiPageReport(reportData) {
    ...
    // Format the pages
    const page1 = formatPage1(companyName, currentDate, 'Jaikaran S', companyDescription);
...
function formatPage1(companyName, valuationDate, authorName, companyDescription) {
    ...
    return `
        ...
        <div class="service-section">
            ...
            <p>Jaikaran S has been engaged to provide a comprehensive valuation service for ${companyName}. This report outlines the valuation methodologies employed, the results derived, and the conclusions drawn to determine the fair value of ${companyName}.</p>
        </div>
    `;
}
        ...
        <div class="methods-container">
            <div class="valuation-method">
                ...
                <div class="recommendation">
                    Jaikaran S values ${companyName} at ${dcfValue} using the DCF method.
                </div>
            </div>
            <div class="valuation-method">
                ...
                <div class="recommendation">
                    Jaikaran S values ${companyName} at ${ccaValue} using the CCA method.
                </div>
            </div>
            <div class="valuation-method">
                ...
                <div class="recommendation">
                    Jaikaran S values ${companyName} at ${ptmValue} using the PTM method.
                </div>
            </div>
        </div>
    `;
    ...
    return `
        ...
        <div class="methods-container">
            <div class="valuation-method">
                ...
                <div class="recommendation">
                    Jaikaran S values ${companyName} at ${abvValue} using the ABV method.
                </div>
            </div>
        </div>
    `;
    ...
    return `
        ...
        <div class="conclusion-section">
            ...
            <div class="footer-section">
                <h2>Prepared by</h2>
                <p>Jaikaran S<br>
                Email: jaikaran.s@example.com</p>
                ...
                <p>
                    ...
                    subject to change based on market conditions, additional data, or other factors. Jaikaran S 
...
function downloadPDF() {
    ...
    pdf.setProperties({
        title: title,
        subject: 'Valuation Report by Jaikaran S',
        creator: 'Jaikaran S'
    });
...
function formatValuationMethod(methodName, description, value) {
    ...
    return `
        <div class="valuation-method">
            ...
            <div class="recommendation">
                Jaikaran S values ${companyName} at ${value} using the ${methodName} method.
            </div>
        </div>
    `;
}
